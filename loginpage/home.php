             ...
             document.getElementById("searchForm").addEventListener("submit", function(event) {
                ...
                if (query !== '') {
                   // Redirect based on search query
                     if (query.toLowerCase().includes("twowheeler")) {
                          window.location.href = "twowheeler.html?query=" + encodeURIComponent(query);
                   } else if (query.toLowerCase().includes("four wheeler")) {
                          window.location.href = "four wheeler.html?query=" + encodeURIComponent(query);
                   } else {
                   ...
                   var products = ["Amaron", "Exide", "twowheeler", "Truck", "Motorcycle"];
